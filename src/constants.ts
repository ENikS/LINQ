...
export var nothingFound = "No element satisfies the condition in predicate";
export var noElements = "The source sequence is empty.";
export var tooMany = "More than one element satisfies the condition in predicate.";
